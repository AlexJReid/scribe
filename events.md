...
`ClaimDiagnosesRecorded`, `ClaimHealthcareCodeRecorded`,
`ClaimProviderTaxonomyRecorded`, `ClaimInstitutionalInformationRecorded`,
`ClaimDateRecorded`, `ClaimServiceLineRecorded`, `ClaimLineDateRecorded`.

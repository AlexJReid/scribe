# Synthetic stroke X12 fixture

Synthetic stroke evaluation and recovery claims: CT imaging, MRI, outpatient
rehab, and neurology follow-up. It is not real patient data.
...
- Service lines can match by claim ID, line number, procedure code, charge
  amount, service date, and line order using 837/835 facts.
